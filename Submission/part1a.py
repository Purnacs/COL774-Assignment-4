...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        for i,(images,labels) in enumerate(tr_syn):
            ...
            print(f'Epoch [{epoch+1}/{num_epochs}], Step [{i+1}/{len(tr_syn)}], Macro Bleu: {bleu_score}, Loss: {loss.item():.4f}')

    print('''Testing Model...''')
    test_datas = [v_syn,t_hw,val_hw]
    test_data_names = {v_syn:"Synthetic Validation",t_hw:"Handwritten Test",val_hw:"Handwritten Validation"}
